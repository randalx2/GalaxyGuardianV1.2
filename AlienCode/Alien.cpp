...
{
	BaseObject::UpdateObject();  //NB THIS IS UPDATION BASED ON MOVEMENT.
	...
	/*if (++frameCount >= frameDelay)
	{
		...
		if (curFrame >= maxFrame)
			...
			curFrame = maxFrame;  //Added -1 to stop flicker if objects don't need much animation

		frameCount = 0;
	}*/ //NB The above algorithm works better for big sprite sheets
...
void Alien::RenderObject()
{
	...
	//int fx = (curFrame % animationColumns) * frameWidth;  //For big sprite sheets
